...
7. [Multi-Dimensional DEX](#multi-dimensional-dex)
8. [Witness Consensus](#witness-consensus)
9. [Economic Game Theory](#economic-game-theory)
10. [Security Bounds](#security-bounds)
11. [Proofs](#proofs)
...
6. **Order preservation:** DEX ordering preserved under forking
7. **Inheritance continuity:** λ controls predictive weight transfer
8. **Multi-generation composition:** Lineage weights multiply across generations
